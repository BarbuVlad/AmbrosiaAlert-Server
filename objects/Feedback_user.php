...
class Feedback_user {
  ...
  private $conn;
  private $table_name = "feedback_users";
 ...
 public $type;
  ...
  public function create() {
    //Create query
    $query = "INSERT INTO " . $this->table_name . " (vendor_id, latitude, longitude, time, type)" . 
    " VALUES(:vendor_id, :latitude, :longitude, :time, :type)";
